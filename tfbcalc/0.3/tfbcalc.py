...
def selectscreen():
    ...
    print("is an integer. \n")
    print("\033[38;5;12m5. About \033[38;5;4m")
    print("About the Python program :D \n")
    time.sleep(0.3)
    print('\033[38;5;13m6. Exit \033[38;5;5m')
...
if user == int(1):
    ...
    def about():
        ...
        time.sleep(0.5)
        print("\033[97mVersion 0.3 alpha build \033[0m")
        print("\033[38;5;63mDiscord: \033[0mtfb2kbaubau")
